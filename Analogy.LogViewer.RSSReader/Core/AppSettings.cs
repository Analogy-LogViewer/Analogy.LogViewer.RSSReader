...
namespace Analogy.LogViewer.RSSReader.Core
{
    ...
    public class AppSettings
    {
        ...
        public class GUISettings
        {
            ...
            {
                string date = Util.GetPropertyName(((IRSSPost itm) => itm.Date));
                string title = Util.GetPropertyName(((IRSSPost itm) => itm.Title));
                string description = Util.GetPropertyName(((IRSSPost itm) => itm.Description));
                string url = Util.GetPropertyName(((IRSSPost itm) => itm.Url));
                string creator = Util.GetPropertyName(((IRSSPost itm) => itm.Creator));
                string content = Util.GetPropertyName(((IRSSPost itm) => itm.Content));
                string read = Util.GetPropertyName(((IRSSPost itm) => itm.Read));
                string link = Util.GetPropertyName(((IRSSPost itm) => itm.Link));
                string feedname = Util.GetPropertyName(((IRSSPost itm) => itm.FeedName));
                string belongstoFeed = Util.GetPropertyName(((IRSSPost itm) => itm.BelongsToFeed));
                string addeddate = Util.GetPropertyName(((IRSSPost itm) => itm.AddedDate));
                string ignoreThisPost = Util.GetPropertyName(((IRSSPost itm) => itm.IgnoreThisPost));
                string ignorePostContentIncomparison = Util.GetPropertyName(((IRSSPost itm) => itm.IgnorePostContentInComparison));
                string followup = Util.GetPropertyName(((IRSSPost itm) => itm.FollowUp));
                string plaintext = Util.GetPropertyName(((IRSSPost itm) => itm.PlainTextPostContent));
