...
namespace Analogy.LogViewer.RSSReader.UI
{
    public partial class FeedInformationDialog : Form
    {
        ...
        private void FeedInformationDialog_Load(object sender, EventArgs e)
        {
            ...
            chklstbCategories.DisplayMember = Util.GetPropertyName((IRSSCategory cat) => cat.CategoryName);
        ...
        private void GetFeedPosts(bool showHiddenPosts)
        {
            ...
            lbldownloadedSize.Text = "Downloaded Size: " + Util.FormatKBytes(Feed.TotalDownloadedKB);
