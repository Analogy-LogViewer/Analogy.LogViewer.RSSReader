...
{
    public partial class SettingsDialogUC : UserControl
    {
        ...
        public void SettingsDialog_FormClosing(object sender, FormClosingEventArgs e)
        {
            SaveSettings(false);
        ...
        private void btnUpdateResetDownloadCount_Click(object sender, EventArgs e)
        {
            if (txtbUpdateFeedName.Tag != null)
            {
                ...
                lblTotalDownloaded.Text = "Total Downloaded Size is: " + Util.FormatKBytes(FeedsContainer[feedindex].TotalDownloadedKB);
        ...
        private void LoadFeedsForCategories()
        {
            ...
            lstbFeedsForCategories.DisplayMember = Util.GetPropertyName((IRSSFeed feed) => feed.RSSName);
